...
| `pause_on_exit` | `boolean` | no | `true` | Whether generated installer scripts should wait briefly before exiting. Runtime flags such as --yes, --cli, and --no-wait skip the wait. |
