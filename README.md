...
entry-point launchers use paths relative to their runtime, so moving or refreshing
an environment does not leave them pointing at an obsolete absolute path.
